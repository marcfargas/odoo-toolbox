...
Create a new lead in Odoo CRM with optional properties
...
Create a basic lead with name and contact info
...
### Lead with Properties

*✓ This example is tested against a live Odoo instance*

Create lead with custom properties fields

```typescript
import { OdooClient, propertiesToWriteFormat, getPropertyValue } from '@odoo-toolbox/client';
...
- [crm_team.py](https://github.com/odoo/odoo/blob/17.0/addons/crm/models/crm_team.py)
