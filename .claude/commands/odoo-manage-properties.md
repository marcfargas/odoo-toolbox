...
Define and manage dynamic properties fields on Odoo models
...
|-----------|------|----------|-------------|
| `model` | string | Yes | Parent model for properties definition (e.g., crm.team for lead_properties) |
| `definitionField` | string | Yes | Field name for properties definition |
| `properties` | array | Yes | Array of property definitions |

## Usage

### Define CRM Lead Properties

*✓ This example is tested against a live Odoo instance*

Create custom properties for CRM leads
...
### Selection Property with Options

*✓ This example is tested against a live Odoo instance*

Create a selection property with predefined options
...
### Read and Modify Properties Values

*✓ This example is tested against a live Odoo instance*

Safely read and update property values on a record
...
- [fields.py#L3188](https://github.com/odoo/odoo/blob/17.0/odoo/fields.py#L3188)
- [fields.py#L3419](https://github.com/odoo/odoo/blob/17.0/odoo/fields.py#L3419)
- [crm_lead.py](https://github.com/odoo/odoo/blob/17.0/addons/crm/models/crm_lead.py)
