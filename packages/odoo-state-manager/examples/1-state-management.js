...
async function main() {
    ...
    const diffs = (0, src_1.compareRecords)('project.project', desiredProjects, actualStates, {
        fieldMetadata,
    });
    ...
    console.log('─────────────────────────────────────────────\n');
    const dryRunResult = await (0, src_1.dryRunPlan)(plan, client, {
        validate: true,
    });
    ...
    console.log('──────────────────────────────\n');
    const applyResult = await (0, src_1.applyPlan)(plan, client, {
        dryRun: false,
        stopOnError: false,
...
//# sourceMappingURL=1-state-management.js.map