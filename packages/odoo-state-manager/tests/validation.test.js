...
const validation_1 = require("../src/plan/validation");
describe('Plan Validation', () => {
    describe('validatePlanReferences', () => {
        it('should pass validation for empty plan', async () => {
            ...
            const result = await (0, validation_1.validatePlanReferences)(plan);
    ...
    describe('formatValidationErrors', () => {
        it('should format passed validation', () => {
            ...
            const output = (0, validation_1.formatValidationErrors)(result);
    ...
    describe('suggestErrorFixes', () => {
        it('should suggest fixes for access denied errors', () => {
            ...
            const fixes = (0, validation_1.suggestErrorFixes)(error);
        ...
        it('should suggest fixes for does not exist errors', () => {
            ...
            const fixes = (0, validation_1.suggestErrorFixes)(error, { model: 'res.partner' });
        ...
        it('should accept string errors', () => {
            const fixes = (0, validation_1.suggestErrorFixes)('Access denied');
            expect(fixes.length).toBeGreaterThan(0);
        });
