...
describe('OdooClient RPC Integration', () => {
    ...
    describe('authentication', () => {
        it('should authenticate with valid credentials', async () => {
            const client = new odoo_client_1.OdooClient({
                url: odooUrl,
                database: odooDb,
                username: odooUser,
        ...
        it('should fail with invalid credentials', async () => {
            ...
            await expect(client.authenticate()).rejects.toThrow(errors_1.OdooAuthError);
        });
        it('should prevent calls before authentication', async () => {
            ...
            await expect(client.search('res.partner')).rejects.toThrow(errors_1.OdooAuthError);
        });
    });
