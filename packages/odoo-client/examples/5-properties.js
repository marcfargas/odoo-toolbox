...
async function main() {
    ...
    try {
        ...
        teamData[0].lead_properties_definition.forEach((def) => {
        ...
        const priorityLevel = (0, src_1.getPropertyValue)(lead.lead_properties, 'priority_level');
        const estimatedRevenue = (0, src_1.getPropertyValue)(lead.lead_properties, 'estimated_revenue');
        ...
        const writeFormat = (0, src_1.propertiesToWriteFormat)(lead.lead_properties);
        ...
        updatedLead[0].lead_properties.forEach((prop) => {
        ...
        const currentProps = (0, src_1.propertiesToWriteFormat)(currentLead[0].lead_properties);
        ...
        const contactAttempts = (0, src_1.getPropertyValue)(finalLead[0].lead_properties, 'contact_attempts');
        const finalPriorityLevel = (0, src_1.getPropertyValue)(finalLead[0].lead_properties, 'priority_level');
...
main();
//# sourceMappingURL=5-properties.js.map