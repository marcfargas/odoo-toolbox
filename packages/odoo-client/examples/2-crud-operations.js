 ...
 */
async function verifyDeleted(client, model, ids) {
...
async function main() {
    ...
    try {
        ...
        const [partner] = await client.read('res.partner', [partnerId], ['id', 'name', 'email', 'phone', 'city', 'is_company']);
        ...
        const [updatedPartner] = await client.read('res.partner', [partnerId], ['email', 'phone', 'street', 'city']);
...
main();
//# sourceMappingURL=2-crud-operations.js.map